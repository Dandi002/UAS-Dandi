...
<html lang="en">
  ...
  <body>
    <div class="container">
    <img src="download.png" class="rounded mx-auto d-block" alt="...">
        ...
        <br>
        <p align="left">Unit Pendidikan</p>
